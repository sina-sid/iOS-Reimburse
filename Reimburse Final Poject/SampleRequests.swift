...
//    }
    ...
    func loadSampleRequests(){
        ...
        // Submitted Requests
        let requester2 = User(first_name: "Jill", last_name: "Dane", andrewID: "jdane", email: "jdane@andrew.cmu.edu", smc: 3008)
        ...
        let requester3 = User(first_name: "Christina", last_name: "Bale", andrewID: "cbale", email: "cbale@andrew.cmu.edu", smc: 1982)
        ...
        // Approved Requests
        let requester4 = User(first_name: "James", last_name: "Bond", andrewID: "jbond", email: "jbond@andrew.cmu.edu", smc: 2010)
